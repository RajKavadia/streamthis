...
import com.streamthis.Config;
import com.streamthis.ItemType;
import com.streamthis.R;
import com.streamthis.WatchVideoActivity;
import com.streamthis.youtubeaudio.YTVideo;
 ...
 */
public class YoutubeBackgroundService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private YTVideo videoItem;

    private boolean isStarting = false;
    private int currentSongIndex = 0;

    private ArrayList<YTVideo> youTubeVideos;
    ...
    private void handleMedia(Intent intent) {
        ...
        switch (intentMediaType) {
            ...
            case YOUTUBE_MEDIA_TYPE_VIDEO:
                ...
                videoItem = (YTVideo) intent.getSerializableExtra(Config.YOUTUBE_TYPE_VIDEO);
            ...
            case YOUTUBE_MEDIA_TYPE_PLAYLIST: //new playlist playback request
                ...
                youTubeVideos = (ArrayList<YTVideo>) intent.getSerializableExtra(Config.YOUTUBE_TYPE_PLAYLIST);
            ...
            mSession.setCallback(
                    new MediaSessionCompat.Callback() {
                        ...
                        public void onStop() {
                            ...
                            Intent intent = new Intent(getApplicationContext(), YoutubeBackgroundService.class);
                            stopService(intent);
                        }
    ...
    private void buildNotification(NotificationCompat.Action action) {
        ...
        Intent clickIntent = new Intent(this, WatchVideoActivity.class);
