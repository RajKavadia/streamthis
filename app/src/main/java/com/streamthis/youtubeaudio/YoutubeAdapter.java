...
import com.streamthis.YoutubeBackgroundService;
    ...
    public void onBindViewHolder(@NonNull myviewholder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                serviceIntent.setAction(YoutubeBackgroundService.ACTION_PLAY);
                serviceIntent.putExtra(Config.YOUTUBE_TYPE, ItemType.YOUTUBE_MEDIA_TYPE_VIDEO);
                YTVideo video  = new YTVideo();
                video.setId(list.get(position).id);
                video.setDuration(list.get(position).Duration);
                video.setThumbnailURL(list.get(position).image);
                video.setViewCount("12323");
